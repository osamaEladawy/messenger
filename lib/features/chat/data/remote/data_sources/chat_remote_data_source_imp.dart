...
import 'package:messenger_app/core/const/firebase_collection_const.dart';
...
class ChatRemoteDataSourceImpl implements ChatRemoteDataSource {
  ...
  Future<void> sendMessageBasedOnType(MessageEntity message) async {
    ...
    final otherMessageRef = fireStore
        ...
        var myMessageDoc = myMessageRef.doc().id;

        var otherMessageDoc = otherMessageRef.doc().id;

        String document = myMessageDoc+otherMessageDoc;
        print(document);
