...
import 'package:messenger_app/core/globel/widgets/display_alret.dart';
        ...
        itemBuilder: (context, index) {
          ...
          if (message.senderUid == widget.messageEntity.senderUid) {
            return _messageLayout(
              ...
              isShowTick: true,
              messageBgColor:Colors.purpleAccent, // messageColor,
            ...
            return _messageLayout(
              ...
              recipientId: message.recipientUid,
              onLongPress: () {
                widget.focusNode.unfocus();
                displayAlertDialog(context, onTap: () {
                  BlocProvider.of<MessageCubit>(context).deleteMessage(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              isShowTick == true?
                               Icon(
                                  ...
                                  size: 16,
                                  color: isSeen == true ? Colors.white : whiteColor,
                                )
                              : Container(),
                            ],
                          ),
                    ...
                    Align(
                      ...
                      child: isShowTick == true?
                              Text(isSeen == true? "seen" : "",style: const TextStyle(
                                color:greyColor
                              ),):Container(),
                    ),
                  ],
